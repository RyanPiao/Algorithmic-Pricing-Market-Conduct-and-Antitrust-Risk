...
## Price Levels: Small, Bandwidth-Sensitive Effects
...
After residualization, estimates are positive at all bandwidths but decline monotonically: 1.93 percent at ±30 days (N = 7,473,139), 0.95 percent at ±45 days (N = 11,184,927), 0.67 percent at ±60 days (N = 14,896,717), and 0.51 percent at ±90 days (N = 22,228,725). All estimates are statistically significant ($p < 0.001$). The declining pattern admits two interpretations: either the algorithm's effect is genuinely concentrated near the rollout date and dilutes as the bandwidth captures more pre/post-period observations, or residual seasonal confounding inflates the narrow-bandwidth estimates. We cannot definitively distinguish these interpretations, though the robustness checks below help narrow the range.
